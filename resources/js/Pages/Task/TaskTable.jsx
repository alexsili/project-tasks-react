...
export default function TaskTable({tasks, success, queryParams = null, hideProjectColumn = false}) {
    ...
    return (
        <>
            {success &&
                (<div className="bg-emerald-600 py-3 px-4 text-white rounded mb-3">
                    {success}
                </div>)
            }
            <div className="overflow-auto">
                <table className="w-full text-sm text-left rtl:origin-top-right text-gray-500 dark:active:bg-gray-300">
                    <thead
                    ...
                    <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-green-400 border-b-2 border-gray-500">
                    <tr className="text-nowrap">
                    ...
                    {tasks.data.map(task => (
                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
                            ...
                            <td className="px-3 py-2"><img className="w-48" src={task.image_path}/>
                            </td>
                            {!hideProjectColumn && (
                            ...
                            <td className="px-3 py-2 text-nowrap">
                                ...
                                <button onClick={e => deleteTask(task)}
                                        className="font-medium text-red-600 dark:text-red-500 hover:underline mx-1">Delete
                                </button>
                            </td>
                        </tr>))}
                    </tbody>
